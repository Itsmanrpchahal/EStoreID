...
public class Constants {
    ...
    public static final String IMAGES = "http://amrsof.tech/estore/public/images/";
    public static final String MERCHANTID ="6871507";
    public static final String MERCHANTKEY ="aRerEwY7";
